...
public record AuthTokenProperties(
        @NotBlank @Size(min = 32, message = "시크릿 키는 32자 이상이어야 합니다.") String secretKey,
    ...
    public record RefreshToken(@NotNull Duration expiration, @NotNull Duration reuseGracePeriod) {}
}
